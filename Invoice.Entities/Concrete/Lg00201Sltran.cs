...
{
    public partial class Lg00201Sltran
    {
        public int Logicalref { get; set; }
        public int? Stficheref { get; set; }
        public int? Sttransref { get; set; }
        public int? Intransref { get; set; }
        public int? Insltransref { get; set; }
        public double? Inslamount { get; set; }
        ...
        public double? Remlnunitamnt { get; set; }
        ...
        public short? Ratescore { get; set; }
        ...
        public double? Diffprcostcurr { get; set; }
        public short? Seriqcok { get; set; }
        ...
        public int? Distordref { get; set; }
        public int? Distordlnref { get; set; }
        public int? Indordsltrnref { get; set; }
        public double? Grossuinfo1 { get; set; }
        public double? Grossuinfo2 { get; set; }
        public double? Ataxprcost { get; set; }
        public double? Ataxprcostcurr { get; set; }
